...
namespace StudyHistoryApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            hanover.Nodes.Add("WRM1", "윌리엄 4세(1830~1837)");
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Name == "ANN1")
            {
                ...
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드, " +
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur qui eum rem " +
                    "assumenda quia, ut repudiandae deleniti laborum nemo veniam optio quisquam earum aperiam " +
                    "esse soluta eligendi unde dolore impedit.";
            }
            else if (e.Node.Name == "GRG1")
            {
                PcbPhoto.Image = Bitmap.FromFile("./Images/King_George_I.jpg");
                TxtDescription.Text = "조지 1세는 1714년 즉위하여 " +
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur qui eum rem " +
                    "assumenda quia, ut repudiandae deleniti laborum nemo veniam optio quisquam earum aperiam " +
                    "esse soluta eligendi unde dolore impedit.";
            }
